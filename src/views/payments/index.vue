<template>
  <div class="app-container">
    ...
    <el-drawer title="结款" :visible.sync="visibleInfo" @close="closeInfo"  size="60%" class="payInfo">
      ...
      <div style="margin: 10px">
        <el-table class="infoD_t" v-loading="listLoading" element-loading-text="Loading" border stripe
          ...
          <!-- <el-table-column label="实收金额" align="center" width="100" class-name="mor inputLi">
            <template slot-scope="scope">
              <div style="
                width: 100%;
                height: 100%;
    ...
    <!-- //开发票记录 -->
    <el-drawer title="结款记录" :visible.sync="visibleClear" @close="closeClear"  size="60%" class="payInfo">
      <Search
        :search="[
     ...
     <div style="margin: 10px;position: absolute;left:0;right:0;bottom:0;top:218px">
       <el-table class="infoD_t" height="100%" v-loading="listLoading" element-loading-text="Loading" border stripe
        ...
        <template slot-scope="scope">
         ...
         <el-table-column label="回执单图片" align="center" width="100" class-name="li inputLi">
          <template slot-scope="scope">
            <div style="height:100%;width:100%;">
            <!-- <div v-for="(item,index) in scope.row.num" :key="index" style="width:100%;border-bottom:1px solid #ebeef5;"> -->
              <!-- <span>1000003</span> -->
              <div style="position:absolute;top:0;right:0;bottom:0;left:0;">
              <el-image fit="contain" :src="imageList[0][0]" :preview-src-list="imageList[0]"><div slot="error" class="image-slot">
      ...
      <el-table-column label="状态" align="center" width="80" class-name="li index">
        ...
        <el-table-column label="时间" align="center" width="170" class-name="li index">
          <template slot-scope="scope">
            <!-- <el-tag :type="scope.row.status | statusFilter">{{
                scope.row.status == 0 ? "进行中" : "已完成"
            }}</el-tag> -->
    ...
    >
      ...
      <el-table-column align="center" label="操作" fixed="right" width="200" class="operation" class-name="button t pay"
          ...
          <template slot-scope="scope" style="display: flex; flex-wrap: wrap" class="operation">
            <el-button type="primary" size="small" @click="openInfo">结款</el-button>
            <el-button type="primary" size="small" @click="openClear">结款记录</el-button>
            <el-button type="info" size="small"></el-button>
            <el-button type="info" size="small"></el-button>
            <el-button type="info" size="small"></el-button>
            <el-button type="info" size="small"></el-button>
